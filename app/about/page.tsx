        ...
        <div className="max-w-4xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-gray-100 p-5 sm:p-6 lg:p-8 mb-4 sm:mb-6">
            ...
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed mb-3 sm:mb-4">
              Компания ООО «ФинЭксперт» является экспертом и надежным партнером для бизнеса, помогая клиентам эффективно решать задачи в условиях современной деловой среды.
            </p>
            
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed mb-3 sm:mb-4">
              Мы объединяем специалистов в области финансового и юридического сопровождения. Наш опыт — это годы практики в государственных и коммерческих проектах.
            </p>
            
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
              Мы понимаем, как довести документацию до требуемого уровня: от корректных расчетов до взаимодействия с проверяющими органами.
            </p>
          </div>
