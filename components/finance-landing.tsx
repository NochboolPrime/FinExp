...
const serviceDetails = [
  ...
  {
    title: "Составление РКМ (расчетно-калькуляционных материалов) под ключ",
    desc: "Полный комплект документов по требованиям ФАС для обоснования цены контракта",
    ...
    content: [
      {
        ...
        items: [
          "Мы готовим расчёты и документы, необходимые для обоснования стоимости продукции, работ или услуг по государственным и коммерческим контрактам",
          "Работаем в соответствии с действующими нормативами, включая требования ФАС и профильных ведомств",
          "Используем затратный и сравнительный методы, подбирая оптимальный подход под конкретную задачу клиента",
        ],
      },
      {
        heading: "Что входит",
        items: [
          "Анализ и структурирование исходных данных, предоставленных клиентом (затраты, спецификации, калькуляции)",
          "Определение оптимального метода расчёта",
          "Подготовка РКМ и сметной обосновывающей документации",
          "Проверка корректности расчетов и соответствия требованиям",
          "Сопровождение при возможных запросах со стороны заказчика/аудита",
        ],
      },
      {
        heading: "Преимущества",
        items: [
          "Экономия времени: вы получаете готовый пакет «под ключ»",
          "Соответствие требованиям контролирующих органов",
          "Минимизация риска возврата или доработки",
      ...
      },
      {
        ...
        items: [
          "Сроки: от 5 рабочих дней после получения всех исходных данных",
          "Стоимость: от 80 000 ₽ (зависит от сложности проекта)",
        ],
      },
    ],
  },
  {
    title: "Подготовка документов для Минпромторга",
    desc: "Получение официальных заключений Минпромторга для применения льгот и соответствия требованиям",
    ...
    content: [
      {
        heading: "Описание услуги",
        items: [
          "Оказываем комплексную поддержку в подготовке и подаче документов для получения заключений Минпромторга",
          "Услуга актуальна для компаний, работающих с импортом, государственными контрактами и налоговыми льготами",
        ],
      },
      {
        heading: "Подтверждение длительности производственного цикла",
        items: [
          "Сбор материалов (контракты, расчёты, графики)",
          "Подготовка технико-экономического обоснования",
          "Формирование пакета в соответствии с требованиями (приказ №807)",
        ],
      },
      {
        heading: "Подтверждение целевого назначения товаров",
        items: [
          "Подготовка заявки",
          "Формирование пакета документов",
          "Обоснование применения налоговых льгот",
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          "Подготовка заявлений и оформленных пакетов по требованиям Минпромторга и профильных приказов (4788, 449)",
